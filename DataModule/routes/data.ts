...
router.post('/saveJournal', function (req, res, next) {
    ...
    let tableService = azure.createTableService(nconf.azureStorage.accountName, nconf.azureStorage.accountKey);
    let entGen = azure.TableUtilities.entityGenerator;

    let answers = journal.answers;
...
router.post('/saveScreening', (req, res, next) => {
    res.json({ result: "ok" });
});
